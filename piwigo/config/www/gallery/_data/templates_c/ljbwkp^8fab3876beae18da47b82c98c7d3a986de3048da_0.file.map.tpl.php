<?php
/* Smarty version 3.1.29, created on 2019-04-19 11:54:37
  from "/config/www/gallery/plugins/rv_gmaps/template/map.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5cb9467dd05be0_50549366',
  'file_dependency' => 
  array (
    '8fab3876beae18da47b82c98c7d3a986de3048da' => 
    array (
      0 => '/config/www/gallery/plugins/rv_gmaps/template/map.tpl',
      1 => 1532347524,
      2 => 'file',
    ),
  ),
...
function content_5cb9467dd05be0_50549366 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
<?php echo '<script'; ?>
 src="//maps.googleapis.com/maps/api/js?sensor=false&amp;language=<?php echo $_smarty_tpl->tpl_vars['lang_info']->value['code'];?>
&amp;libraries=places<?php if (!empty($_smarty_tpl->tpl_vars['GMAPS_API_KEY']->value)) {?>&amp;key=<?php echo $_smarty_tpl->tpl_vars['GMAPS_API_KEY']->value;
}?>" type="text/javascript"><?php echo '</script'; ?>
>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['combine_script'][0][0]->func_combine_script(array('id'=>'jquery','load'=>'header','path'=>'//ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js'),$_smarty_tpl);?>
